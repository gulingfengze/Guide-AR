...
public class Radar {
    ...
    public static final float RADIUS = 110;//雷达半径
    ...
    private static final int RADAR_COLOR = Color.argb(100, 0, 0, 255);//雷达颜色
    private static final int TEXT_COLOR = Color.rgb(255, 255, 255);//文本颜色（白色）
    //private static final int TEXT_SIZE = 12;//文本大小
    private static final int TEXT_SIZE = 15;//文本大小
    ...
    private static PaintableRadarPoints radarPoints = null;//点
    private static PaintablePosition pointsContainer = null;//点容器
