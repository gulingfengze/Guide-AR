...
/**
 * 继承NetworkDataSource数据源，从Google Places获取数据。
 */
...
//	private static final String URL = "http://maps.google.cn/maps/api/place/search/json?";
	...
	//下面一行为所有兴趣点ID，可以通过修改获取其他兴趣点，比如美食等
	//private static final String TYPES = "library|airport|amusement_park|aquarium|art_gallery|bus_station|campground|car_rental|city_hall|embassy|establishment|hindu_temple|local_governemnt_office|mosque|museum|night_club|park|place_of_worship|police|post_office|stadium|spa|subway_station|synagogue|taxi_stand|train_station|travel_agency|大学|zoo";
	//private static final String TYPES = "restaurants|hotels|food";
	private static final String TYPES = "pharmacy";
